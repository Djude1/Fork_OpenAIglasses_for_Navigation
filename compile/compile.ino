...
// UDP_HOST 改用 SERVER_HOST（由自動探索填入）
...
bool imu_init_spi(){
  ...
  Serial.printf("[IMU] WHO_AM_I=0x%02X (expect 0x47) -> %s\n", who, who == 0x47 ? "TRUE" : "ERROR");
...
// ====================================================================
// 自動探索伺服器 IP（廣播 AIGLASS_DISCOVER，等待 Python 回應）
// ====================================================================
